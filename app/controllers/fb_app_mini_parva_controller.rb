#coding: utf-8
class FbAppMiniParvaController < ApplicationController
  layout "fb_app_mini_parva"
...
private
  ...
  def load_application_data
    @app_id = '1387465434806996' if Rails.env.development?
    @app_id = '547598438620750' if Rails.env.production?
