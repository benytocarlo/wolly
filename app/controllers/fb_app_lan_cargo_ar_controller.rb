...
class FbAppLanCargoArController < ApplicationController
  ...
  def share
    ...
    @graph.put_wall_post("", {
        ...
        :description => "¡Ya jugué el Quiz Imposible y estoy concursando por 2 pasajes a Lima! ¡Participá tú también AQUÍ!",
  ...
  def volver_jugar
    ...
    @graph.put_wall_post("", {
        ...
        :link => "http://www.facebook.com/LANenChile/app_346195818816496",
        :caption => "Cargas Imposibles de Nat Geo y LAN CARGO",
        :description => "¡Estoy jugando el Quiz Imposible de Nat Geo y LAN CARGO para participar por 2 pasajes a Lima, Perú! ¡Concursá tú también AQUÍ!",
        :picture => "http://wolly.herokuapp.com/assets/fb_app_lan_cargo_ar/75x75.jpg"
    }, @me_from_graph[:id])
