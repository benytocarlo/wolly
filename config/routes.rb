...
#== Route Map
# Generated on 29 May 2013 18:42
#
...
#              fb_app_claro_ganate_la_parabolica POST       /fb_app_claro_ganate_la_parabolica(.:format)              fb_app_claro_ganate_la_parabolica#index
#                                                GET        /fb_app_claro_ganate_la_parabolica(.:format)              fb_app_claro_ganate_la_parabolica#index
#      fb_app_claro_ganate_la_parabolica_premios GET        /fb_app_claro_ganate_la_parabolica_premios(.:format)      fb_app_claro_ganate_la_parabolica#premios
#     fb_app_claro_ganate_la_parabolica_registro GET        /fb_app_claro_ganate_la_parabolica_registro(.:format)     fb_app_claro_ganate_la_parabolica#registro
#                                                POST       /fb_app_claro_ganate_la_parabolica_registro(.:format)     fb_app_claro_ganate_la_parabolica#procesar_registro
#      fb_app_claro_ganate_la_parabolica_ranking GET        /fb_app_claro_ganate_la_parabolica_ranking(.:format)      fb_app_claro_ganate_la_parabolica#ranking
# fb_app_claro_ganate_la_parabolica_laparabolica GET        /fb_app_claro_ganate_la_parabolica_laparabolica(.:format) fb_app_claro_ganate_la_parabolica#laparabolica
#        fb_app_claro_ganate_la_parabolica_bases GET        /fb_app_claro_ganate_la_parabolica_bases(.:format)        fb_app_claro_ganate_la_parabolica#bases
